...
=back
    ...
    $parsed_text = Side7::Util::Text::parse_bbcode_markup( $original_text, \%args );
...
=back
    ...
    my $text = Side7::Util::Text::tag_usernames( $text );
...
=back
    ...
    my $int = Side7::Util::Text::true_false_to_int( $text );
...
=back
    ...
    my $new_text = Side7::Util::Text::sanitize_text_for_html( $text );
...
=back
    ...
    my $new_text = Side7::Util::Text::escape_quotes( $text );
...
=back
    ...
    my $filtered_text = Side7::Util::Text::filter_profanity( text => $text );
...
=back
    ...
    my $pronoun = Side7::Util::Text::get_pronoun( sex => $sex, part_of_speech => $speech );
